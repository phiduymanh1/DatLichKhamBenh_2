...
public class DichVuKhamIplm implements Icomon<DichVuKhamResponse> {
    ...
    @Override
    public void addOrUpdate(DichVuKhamResponse object) {
    ...
    @Override
    public void delete(DichVuKhamResponse object) {
